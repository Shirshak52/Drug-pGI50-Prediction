...
class GNN(nn.Module):
    def __init__(self, node_feature_dim, global_feature_dim, hidden_channels, num_layers):
    ...
    def forward(self, data):
        ...
        global_features = data.global_features # Access the global features stored in the Data object
        ...
        global_features = global_features.float().view(current_batch_size, self.global_feature_dim)
        x = torch.cat([x, global_features], dim=1) # Concatenate along the feature dimension
